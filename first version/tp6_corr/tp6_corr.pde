...
//          //fill(255,0,0);
//            for (int l=-WALLD; l<1; l++) {

//              laby0.vertex(i*wallW-wallW/2+(k+0)*wallW/WALLD, j*wallH-wallH/2, ((l+0)*50/WALLD)*p);
//              laby0.vertex(i*wallW-wallW/2+(k+1)*wallW/WALLD, j*wallH-wallH/2, ((l+0)*50/WALLD)*p);
//               //laby0.fill(i*25, j*25, 255-i*10+j*10);
//              laby0.vertex(i*wallW-wallW/2+(k+1)*wallW/WALLD, j*wallH-wallH/2, ((l+1)*50/WALLD)*p);
//              laby0.vertex(i*wallW-wallW/2+(k+0)*wallW/WALLD, j*wallH-wallH/2, ((l+1)*50/WALLD)*p);
//            }
//        }
//        }
...
//              laby0.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+0)*wallW/WALLD, ((l+1)*50/WALLD)*p);
//              laby0.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+1)*wallW/WALLD, ((l+1)*50/WALLD)*p);
//              laby0.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+1)*wallW/WALLD, ((l+0)*50/WALLD)*p);
//              laby0.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+0)*wallW/WALLD, ((l+0)*50/WALLD)*p);
//            }
//        }
...
//            }
//        }
//        ceiling1.fill(255,0,0);
//        ceiling1.vertex(i*wallW-wallW/2, j*wallH-wallH/2, 50*p);
//        ceiling1.vertex(i*wallW+wallW/2, j*wallH-wallH/2, 50*p);
//        ceiling1.vertex(i*wallW+wallW/2, j*wallH+wallH/2, 50*p);
//        ceiling1.vertex(i*wallW-wallW/2, j*wallH+wallH/2, 50*p);        
//      } else {
//        laby0.fill(1,220,0); // ground
//        laby0.vertex(i*wallW-wallW/2, j*wallH-wallH/2, -50*p, 0, 0);
//        laby0.vertex(i*wallW+wallW/2, j*wallH-wallH/2, -50*p, 0, 1);
//        laby0.vertex(i*wallW+wallW/2, j*wallH+wallH/2, -50*p, 1, 1);
//        laby0.vertex(i*wallW-wallW/2, j*wallH+wallH/2, -50*p, 1, 0);
        
//        ceiling0.fill(255,200,200); // top of walls
//        ceiling0.vertex(i*wallW-wallW/2, j*wallH-wallH/2, 50*p);
//        ceiling0.vertex(i*wallW+wallW/2, j*wallH-wallH/2, 50*p);
//        ceiling0.vertex(i*wallW+wallW/2, j*wallH+wallH/2, 50*p);
//        ceiling0.vertex(i*wallW-wallW/2, j*wallH+wallH/2, 50*p);
//      }
...
//    }
//    //Draw the flor
//        laby0.fill(255,0,255);
//        laby0.vertex(0, 0, 200, 0, 0);
//        laby0.vertex(LAB_SIZE*50.0 ,0, 200, 0, 1);
//        laby0.vertex(LAB_SIZE*50.0, LAB_SIZE*50.0, 200, 1, 1);
//        laby0.vertex(0, LAB_SIZE*50.0, 200, 1, 0);
//  }
...
//// camera(width/2.0, height/2.0,2500, width/2.0, height/2.0, 0, 0,1,0);
//  noLights();
//  stroke(0);
//  for (int j=0; j<LAB_SIZE; j++) {
//    for (int i=0; i<LAB_SIZE; i++) {
...
//          for (int k=0; k<1; k++)
//            for (int l=-WALLD; l<WALLD; l++) {
//              laby0.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+0)*wallW/WALLD, (l+1)*50/WALLD);
//              laby0.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+1)*wallW/WALLD, (l+1)*50/WALLD);
//              laby0.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+1)*wallW/WALLD, (l+0)*50/WALLD);
//              laby0.vertex(i*wallW-wallW/2, j*wallH-wallH/2+(k+0)*wallW/WALLD, (l+0)*50/WALLD);
//            }
//        }
...
void setup() { 
  ProgrammeShader = loadShader("fragmentShader.glsl", "vertexShader.glsl");
