...
//        if (j==0 || labyrinthe[level][j-1][i]==' ') {
//          laby0.normal(0, -1, 0);
//          for (int k=0; k<WALLD; k++)
//            for (int l=-WALLD; l<WALLD; l++) {
//              laby0.vertex(i*wallW-wallW/2+(k+0)*wallW/WALLD+z, j*wallH-wallH/2+z, z+(l+0)*50/WALLD);
//              laby0.vertex(i*wallW-wallW/2+(k+1)*wallW/WALLD+z, j*wallH-wallH/2+z, z+(l+0)*50/WALLD);
//              laby0.vertex(i*wallW-wallW/2+(k+1)*wallW/WALLD+z, j*wallH-wallH/2+z, z+(l+1)*50/WALLD);
//              laby0.vertex(i*wallW-wallW/2+(k+0)*wallW/WALLD+z, j*wallH-wallH/2+z, z+(l+1)*50/WALLD);
//            }
//        }
////lower
//        if (j==LAB_SIZE-1 || labyrinthe[level][j+1][i]==' ') {
//          laby0.normal(0, 1, 0);
//          for (int k=0; k<WALLD; k++)
//            for (int l=-WALLD; l<WALLD; l++) {
//              laby0.vertex(i*wallW-wallW/2+(k+0)*wallW/WALLD+z, j*wallH+wallH/2+z, z+(l+1)*50/WALLD);
...
//        }
////right walls
//        if (i==0 || labyrinthe[level][j][i-1]==' ') {
//          laby0.normal(-1, 0, 0);
//          for (int k=0; k<1; k++)
//            for (int l=-WALLD; l<WALLD; l++) {
//              laby0.vertex(i*wallW-wallW/2+z, j*wallH-wallH/2+(k+0)*wallW/WALLD+z, z+(l+1)*50/WALLD);
//              laby0.vertex(i*wallW-wallW/2+z, j*wallH-wallH/2+(k+1)*wallW/WALLD+z,z+(l+1)*50/WALLD);
//              laby0.vertex(i*wallW-wallW/2+z, j*wallH-wallH/2+(k+1)*wallW/WALLD+z,z+(l+0)*50/WALLD);
//              laby0.vertex(i*wallW-wallW/2+z, j*wallH-wallH/2+(k+0)*wallW/WALLD+z, z+(l+0)*50/WALLD);
//            }
//        }
////left
//        if (i==LAB_SIZE-1 || labyrinthe[level][j][i+1]==' ') {
//          laby0.normal(1, 0, 0);
//          for (int k=0; k<1; k++)
//            for (int l=-WALLD; l<WALLD; l++) {
//              laby0.vertex(i*wallW+wallW/2+z, j*wallH-wallH/2+(k+0)*wallW/WALLD+z, (l+0)*50/WALLD+z);
//              laby0.vertex(i*wallW+wallW/2+z, j*wallH-wallH/2+(k+1)*wallW/WALLD+z,(l+0)*50/WALLD+z);
//              laby0.vertex(i*wallW+wallW/2+z, j*wallH-wallH/2+(k+1)*wallW/WALLD+z, (l+1)*50/WALLD+z);
//              laby0.vertex(i*wallW+wallW/2+z, j*wallH-wallH/2+(k+0)*wallW/WALLD+z, (l+1)*50/WALLD+z);
//            }
//        }
...
//      }
//    }
//        // laby0.fill(250,0,250); // ground
//        //laby0.vertex(, j*wallH-wallH/2+z, z -50, 0, 0);
//        //laby0.vertex(i*wallW+wallW/2+z, j*wallH-wallH/2+z, z-50, 0, 1);
//        //laby0.vertex(i*wallW+wallW/2+z, j*wallH+wallH/2+z, z-50, 1, 1);
//        //laby0.vertex(i*wallW-wallW/2+z, j*wallH+wallH/2+z, z-50, 1, 0);
...
////void losange(int size, int k ){
////  //losange vert
////  float wallW = width/LAB_SIZE;
////  float wallH = height/LAB_SIZE;
////  //beginShape(QUADS);
////  //fill(0,255,128);
////  //vertex(0, size*wallW,90);
////  //vertex(size*wallW, size*wallW,90);
////  //vertex((size-k)*wallW, (size-k)*wallH,90);
////  //vertex(k*wallW,(size-k)*wallH,90);
////  //endShape();
  
////  //beginShape(QUADS);
////  //fill(0,255,128);
////  //vertex(wallW*2, size*wallH - 2*wallH,200);
////  //vertex((size-2)*wallW  , (size-2)*wallH, 200);
////  //vertex((size-4)*wallW, (size-4)*wallH,200);
////  //vertex(4*wallW,(size-4)*wallH,200);
////  //endShape();
...
//  beginShape(QUADS);
//  fill(255,255,128);
//  vertex(0+z, size*wallW+z, 0+z);
//  vertex(size*wallW+z, size*wallW+z,0+z);
//  vertex(size*wallW+z, size*wallW+z,90+z);
//  vertex(0+z, size*wallW+z,90+z);
//  endShape();
//  beginShape(QUADS);
//  fill(255,255,128);
//  vertex(size*wallW+z, size*wallW+z,90+z);
//  vertex(0+z, size*wallW+z,90+z);
//  vertex(0+z+90, size*wallW+z-90,90+z);
//  vertex(size*wallW+z-90, size*wallW+z-90,90+z);
//  endShape();
...
//  fill(255,128,255);
//  vertex(0+z, 0+z, 0+z);
//  vertex(0+z, size*wallH+z,0+z);
//  vertex(0+z, size*wallH+z,90+z);
//  vertex(0+z, 0+z,90+z);
//  endShape();
//  beginShape(QUADS);
//  fill(255,128,0);
...
//  fill(255,128,255);
//  vertex(0+z, 0+z, 0+z);
//  vertex(size*wallW+z, 0+z,0+z);
//  vertex(size*wallW+z, 0+z,90+z);
//  vertex(0+z, 0+z,90+z);
//  endShape();
//  beginShape(QUADS);
//  fill(255,128,255);
...
//  vertex(0+z, 0+z,90+z);
//  vertex(0+z+90, 0+z+90,90+z);
//  vertex(size*wallW+z-90,z+90,90+z);
//  endShape();
  
//  //mur droite + losange
//  beginShape(QUADS);
//  fill(128,255,255);
//  vertex(size*wallH+z, 0+z,0+z);
//  vertex(size*wallH+z, size*wallH+z,0+z);
//  vertex(size*wallH+z, size*wallH+z,90+z);
//  vertex(size*wallH+z, 0+z,90+z);
//  endShape();
//  beginShape(QUADS);
//  fill(0,255,128);
//  vertex(size*wallH+z, size*wallH+z,90+z);
//  vertex(size*wallH+z, 0+z,90+z);
//  vertex(size*wallH+z-90, 0+z+90,90+z);
//  vertex(size*wallH+z-90, size*wallH+z-90,90+z);
...
//  }
//}
  //asma correctde the lab and we have the walls and losanges
  int iposX = 1;
int iposY = -1;
...
void createPyr(int size, int z) {
  ...
  beginShape(QUADS);
  texture(texture1);
  vertex(wallW/2+z, wallW/2+z, wallW/2+z,0, 0);
  vertex(wallW/2+z, size*wallH+z,0+z,0, 910);
  vertex(wallW/2+z, size*wallH+z,90+z, 90, 910);
  vertex(wallW/2+z, wallW/2+z,90+z,90, 0);
  endShape();
  beginShape(QUADS);
  texture(texture1);
  vertex(0+z, size*wallH+z,90+z, 0, 0);
  ...
  beginShape(QUADS);
  texture(texture1);
  vertex(size*wallH+z, 0+z,0+z,0, 0);
  vertex(size*wallH+z, size*wallH+z,0+z,0, 910);
  vertex(size*wallH+z, size*wallH+z,90+z, 90, 910);
...
boolean isInLab(int posX, int posY){
